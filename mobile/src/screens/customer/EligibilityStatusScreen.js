...
const EligibilityStatusScreen = ({ navigation }) => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      setEligibleData(eligibilityState);
              ...
              {eligibleData ? (
                <>
                  <MaterialCommunityIcons
                    name={
                      getStatusIcon(
                        eligibleData.isVerified ? "verified" : "pending",
                      ).icon
                    }
                    size={40}
                    color={
          ...
          {eligibleData ? (
              ...
              <View style={styles.actionsContainer}>
                {!eligibleData.isVerified && (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      navigation.navigate("EligibilityApply", {
                        data: eligibleData,
                      })
                    }
                  >
            ...
            <View style={styles.noEligibilityContainer}>
              <MaterialCommunityIcons
                ...
                color="#9E9E9E"
              />
              <Text style={styles.noEligibilityTitle}>
                No Eligibility Status
              </Text>
            ...
            <View style={styles.benefitsCard}>
              <View style={styles.benefitItem}>
                ...
                <View style={styles.benefitContent}>
                  <Text style={styles.benefitTitle}>5% Discount</Text>
