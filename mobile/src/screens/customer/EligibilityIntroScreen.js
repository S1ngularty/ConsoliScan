...
const EligibilityIntroScreen = ({ navigation }) => {
  ...
  React.useEffect(() => {
    (() => {
      console.log(userState?.eligible)
      if (userState.eligible && userState.eligible?.isVerified)
        navigation.navigate("EligibilityStatus");
      return;
    })();
  }, [userState]);
  ...
  const eligibilityTypes = [
    {
      ...
      description:
        "Persons with visual, hearing, physical, or mental disabilities",
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroDescription}>
            Apply for PWD or Senior Citizen eligibility to enjoy special
          ...
          <View style={styles.typesContainer}>
            {eligibilityTypes.map((type) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("EligibilityApply", { type: type.id })
                }
                activeOpacity={0.8}
              >
        ...
        <View style={styles.ctaSection}>
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("EligibilityApply", { type: "pwd" })
            }
            activeOpacity={0.8}
          >
            <MaterialCommunityIcons
