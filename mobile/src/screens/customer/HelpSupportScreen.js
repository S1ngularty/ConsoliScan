  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        >
          <MaterialCommunityIcons name="message-plus" size={22} color="#0f172a" />
        </TouchableOpacity>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {filteredFAQs.length > 0 ? (
          filteredFAQs.map((section) => (
            <View key={section.id} style={styles.faqSection}>
              <View style={styles.faqSectionHeader}>
                ...
                <Text style={styles.faqCount}>{section.questions.length} questions</Text>
              </View>
          ...
          <View style={styles.noResults}>
            <MaterialCommunityIcons name="help-circle" size={48} color="#cbd5e1" />
        ...
        <View style={styles.tipsCard}>
          <MaterialCommunityIcons name="lightbulb-on" size={24} color="#0f172a" />
          <View style={{ flex: 1, marginLeft: 16 }}>
            <Text style={styles.tipsTitle}>Need urgent assistance?</Text>
            <Text style={styles.tipsText}>
              Our support team is available 24/7. Tap any contact option above to get immediate help.
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <MaterialCommunityIcons name="form-textbox" size={28} color="#00A86B" />
          <View style={styles.supportFormContent}>
            <Text style={styles.supportFormTitle}>Submit a Support Request</Text>
