...
function DashboardPage() {
  const stats = [
    { title: "Total Sales", value: "$12,450.50", icon: <DollarSign />, trend: "+12.5%", color: "green" },
    { title: "Active Users", value: "1,050", icon: <Users />, trend: "+3.2%", color: "blue" },
    { title: "Products Sold", value: "482", icon: <Package />, trend: "+18%", color: "orange" },
    { title: "Conversion", value: "3.4%", icon: <TrendingUp />, trend: "-0.5%", color: "purple" },
  ];
        ...
        {stats.map((stat, index) => (
          <div key={index} className="stat-card">
            <div className="stat-content">
              ...
              <p className={`stat-trend ${stat.trend.startsWith('+') ? 'up' : 'down'}`}>
        ...
        <div className="recent-activity">
          ...
          <ul className="activity-list">
            ...
            <li className="activity-item">
              ...
              <p className="item-amount" style={{color: '#3b82f6'}}>Verified</p>
            </li>
          </ul>
        </div>
      </div>
